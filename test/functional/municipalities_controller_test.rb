...
class MunicipalitiesControllerTest < ActionController::TestCase
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post :create, municipality: { latitude: @municipality.latitude, longitude: @municipality.longitude, name: @municipality.name, state_id: @municipality.state_id }
    end
  ...
  test "should update municipality" do
    put :update, id: @municipality, municipality: { latitude: @municipality.latitude, longitude: @municipality.longitude, name: @municipality.name, state_id: @municipality.state_id }
    assert_redirected_to municipality_path(assigns(:municipality))
  end
